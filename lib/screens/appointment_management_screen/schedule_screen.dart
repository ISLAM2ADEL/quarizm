...
class ScheduleScreen extends StatelessWidget {
  ...
  final String drDay;
  final String drTime;
  const ScheduleScreen({super.key, required this.drName, required this.drDay, required this.drTime});
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  customContainers(context,height, width,text: "Cancel", color: Colors.redAccent.shade400),
                                ],
                              ),
                              SizedBox(height: height * .03,)
                            ]
  ...
  Widget customContainers(BuildContext context,double height, double width,{
    ...
    return GestureDetector(
      ...
      onTap: (){
        text=="Cancel"?Navigator.pop(context):
        Navigator.of(context).push(
